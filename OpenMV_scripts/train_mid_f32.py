# train_mid_f32.py — Float32 MobileNetV2 (固件4.8.1兼容)
# 基于 train_mid.py, 去掉INT8量化, 导出Float32
...
FINE_EPOCHS = 10
DATA_DIR    = "dataset"
MODEL_OUT   = "model_mid_f32.tflite"
LABELS_OUT  = "labels.txt"
ALPHA       = 0.35
# ==================

# 1. 扫描类别
CLASS_ORDER = ["red_hexagon", "green_circle", "yellow_rect", "none"]
class_dirs = set([
...
# 6. 导出 Float32 TFLite (不量化, 固件4.8.1兼容)
...
print("Copy %s and %s to OpenMV flash." % (MODEL_OUT, LABELS_OUT))
