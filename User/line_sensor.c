...
// Normal driving: center sensor on line, error=0 鈫?error=0
...
// 鍗佸瓧璺彛妫�娴? 5 璺叏閮ㄦ娴嬪埌绾?(甯?3 甯ф秷鎶?
bool LineSensor_AllOn(void)
{
    ...
    /* LineSensor_Read 内部已有 3 帧消抖, 这里 1 帧全亮即触发 (十字路口判得快) */
    return (on == 5);
}
